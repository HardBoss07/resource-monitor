...
use data_structures::{ResourceData, CpuInfo, SystemInfo, MemoryInfo};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![greet, get_all_resource_data, get_cpu_data, get_system_data, get_memory_data])
